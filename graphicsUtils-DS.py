...
_canvas_ys = None
_canvas_x = None      # Current location on canvas
_canvas_y = None
_canvas_col = None      # Current colour (fix to black below)
_canvas_tsize = 12
_canvas_tserifs = 0
...
def square(position, r, color, filled=1, behind=0):
    x, y = position
    coords = [(x - r, y - r), (x + r, y - r), (x + r, y + r), (x - r, y + r)]
    return polygon(coords, color, color, filled, 0, behind=behind)


def circle(position, r, outlineColor, fillColor, endpoints=None, style='pieslice', width=2):
    x, y = position
    x0, x1 = x - r - 1, x + r
    y0, y1 = y - r - 1, y + r
    if endpoints == None:
...
def image(position, file="../../blueghost.gif"):
    x, y = position
